          ...
          <div class="card-body ">
            ...
            <div class="card mt-3">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <img src="{{asset('assets/img/'.$item->logo)}}" style="width: 100%;" alt="">
                  </div>
                  <div class="col-md-6">
                    <div class="container mt-3">
                      <form action="{{route('uploadlogo')}}" method="post" enctype="multipart/form-data">
                        @csrf

                        <h6>Change Logo</h6>
                        <input type="file" name="newlogo" required class="form-control" accept="image/*">
                        <button type="submit" class="btn btn-primary px-4 mt-3">Upload Logo</button>
                      </form>
                    </div>
            ...
            <div class="card shadow">
              <div class="card-body justify-content-center">
                <form action="{{route('savePhoto')}}" method="post" enctype="multipart/form-data">
                  ...
                  @php
                  $allphoto = DB::select('SELECT * FROM `photos` where fkid = '.$item->id.' and photo_type ="header" ');
                  @endphp
                  <ul class="list-group list-group-flush" style="text-align: center;">
                    @foreach ($allphoto as $key => $pp)
                    <li class="list-group-item"><img src="{{asset('assets/img/'.$pp->photos)}}" style="width: 300px; height:300px" alt="">
                      <br />
                      <button type="button" class="btn btn-danger btndelete btn-sm px-3" data-id="{{$pp->id}}">Delete this photo</button>
                    </li>
                    @endforeach
                  ...
                  <input type="file" required class="form-control" multiple accept="image/*" name="photofile[]">
                  <br>
...
<script>
  $('.btndelete').click(function() {
    var id = $(this).data('id');
    window.location.href = '{{route("deleteall")}}?id=' + id + "&table=photos";
  })
