@extends('layouts.app', ['activePage' => 'projects', 'title' => '', 'navName' => 'Projects', 'activeButton' => 'laravel'])
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><textarea name="" data-table="projects" data-entity="title" data-id="{{$item->id}}" class="form-control updateonmove" id="" cols="30" rows="10">{{$item->title}}</textarea></td>
                  <td><textarea name="" data-table="projects" data-entity="desc" data-id="{{$item->id}}" class="form-control updateonmove" id="" cols="30" rows="10">{{$item->desc}}</textarea></td>
                  <td><button data-id="{{$item->id}}" data-table="projects" class="btn btn-sm btn-danger delete"><i class="fas fa-trash-can"></i></button></td>
                </tr>
                @endforeach
